...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { date: @concert.date, location: @concert.location, title: @concert.title } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { date: @concert.date, location: @concert.location, title: @concert.title } }
