...
class MusiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create musician" do
    assert_difference('Musician.count') do
      post musicians_url, params: { musician: { avatar_url: @musician.avatar_url, name: @musician.name } }
    end
  ...
  test "should update musician" do
    patch musician_url(@musician), params: { musician: { avatar_url: @musician.avatar_url, name: @musician.name } }
